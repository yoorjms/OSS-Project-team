...
driver = webdriver.Chrome(chrome_path)
driver.get("http://www.bigsizeclub.co.kr/")
driver.find_element_by_xpath("""//*[@id="topmenu_first"]/div/div[2]/form/fieldset/a/i""").click()
#river.find_element_by_xpath("""//*[@id="cate_top"]/a""").click()
element = driver.find_element_by_name("content1")
driver.execute_script("arguments[0].value = '티';",element)
driver.find_element_by_xpath("""//*[@id="search_form"]/fieldset/div/table/tbody/tr[1]/td[3]/div/a/img""").click()
